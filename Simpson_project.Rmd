...
setwd("C:/Users/Dan/OneDrive/Documents/Online_Courses/Udacity_nano/DataAnalyst/project4_R")
...
Let's explote a dataset on The Simpsons, the [longest-running](https://en.wikipedia.org/wiki/The_Simpsons), and in my opinion best, American TV sitcom of all time. This dataset is available on Kaggle [here](https://www.kaggle.com/wcukierski/the-simpsons-by-the-data)
...
simp.characters <- read.csv(file = "simpsons_characters.csv") 

#contains data on each episode
simp.episodes <- read.csv(file = "simpsons_episodes2.csv") 

#contains data on locations in the show
simp.location <- read.csv(file = "simpsons_locations.csv") 

#contains the script of each episode and who is speaking
simp.words <- read.csv(file = "simpsons_script_lines2.csv") 
